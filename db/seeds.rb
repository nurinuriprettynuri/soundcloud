...
user1.image.attach(io: open('https://s3-us-west-1.amazonaws.com/soundcloud-dev/1-1.jpeg'), filename: 'avatar.jpg')
user2.image.attach(io: open('https://s3-us-west-1.amazonaws.com/soundcloud-dev/1-2.jpg'), filename: 'avatar.jpg')
user3.image.attach(io: open('https://s3-us-west-1.amazonaws.com/soundcloud-dev/1-3.jpg'), filename: 'avatar.jpg')
user4.image.attach(io: open('https://s3-us-west-1.amazonaws.com/soundcloud-dev/1-4.png'), filename: 'avatar.jpg')
user5.image.attach(io: open('https://s3-us-west-1.amazonaws.com/soundcloud-dev/1-5.png'), filename: 'avatar.jpg')
user6.image.attach(io: open('https://s3-us-west-1.amazonaws.com/soundcloud-dev/1-6.jpg'), filename: 'avatar.jpg')
user7.image.attach(io: open('https://s3-us-west-1.amazonaws.com/soundcloud-dev/1-7.jpg'), filename: 'avatar.jpg')
user8.image.attach(io: open('https://s3-us-west-1.amazonaws.com/soundcloud-dev/1-8.png'), filename: 'avatar.jpg')
user9.image.attach(io: open('https://s3-us-west-1.amazonaws.com/soundcloud-dev/1-9.png'), filename: 'avatar.jpg')
user10.image.attach(io: open('https://s3-us-west-1.amazonaws.com/soundcloud-dev/1-10.png'), filename: 'avatar.jpg')
user11.image.attach(io: open('https://s3-us-west-1.amazonaws.com/soundcloud-dev/1-11.jpg'), filename: 'avatar.jpg')
user12.image.attach(io: open('https://s3-us-west-1.amazonaws.com/soundcloud-dev/1-12.png'), filename: 'avatar.jpg')
user13.image.attach(io: open('https://s3-us-west-1.amazonaws.com/soundcloud-dev/1-13.png'), filename: 'avatar.jpg')
user14.image.attach(io: open('https://s3-us-west-1.amazonaws.com/soundcloud-dev/1-14.png'), filename: 'avatar.jpg')
user15.image.attach(io: open('https://s3-us-west-1.amazonaws.com/soundcloud-dev/1-15.jpg'), filename: 'avatar.jpg')
user16.image.attach(io: open('https://s3-us-west-1.amazonaws.com/soundcloud-dev/1-16.png'), filename: 'avatar.jpg')
user17.image.attach(io: open('https://s3-us-west-1.amazonaws.com/soundcloud-dev/1-17.png'), filename: 'avatar.jpg')
